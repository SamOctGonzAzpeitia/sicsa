...
@section('titulo')
    Control Administrativo de Colonos
@endsection
@section('seccion')

    <div class="p-5 mb-4 bg-body-tertiary rounded-3" style="background-image: url('img/fd_cac1.jpg'); width: 1200;">
        <div class="container-fluid py-5">
            <h1 class="display-5 fw-bold">Control Administrativo de Colonos</h1>
            <p class="col-md-8 fs-4">Nuestro sistema de control de colonos es la solución perfecta para simplificar y mejorar la administración de comunidades y conjuntos habitacionales. </p>
